...
const Cards = () => {
  return (
    <div className="mt-20 ">
      <div className="lg:flex bg-white h-[255px] rounded-lg">
        <Container
      ...
      <div className="lg:flex bg-white h-[255px] mt-7 rounded-lg">
        <Container
          className="w-full lg:w-[25%] pt-12 py-5 relative"
          sx={{
            "& img": {
      ...
      <div className="lg:flex bg-white mt-7 rounded-lg">
        <Container
          className="w-full lg:w-[25%] pt-12 py-5 relative"
          sx={{
            "& img": {
        ...
        <div className="w-full lg:w-[50%] py-5 px-5 lg:px-0">
          ...
          <div className=" px-2 py-2 space-y-2 rounded-lg ml-5">
            <p><span className="w-4 h-4 bg-sky-200 rounded-full"><FaCheck /></span> Documentation</p>
            <p><span className="w-4 h-4 bg-sky-200 rounded-full"><FaCheck /></span> Easy Use</p>
            <p><span className="w-4 h-4 bg-sky-200 rounded-full"><FaCheck /></span> Out of box</p>
          </div>
          <p className="flex items-center gap-2 text-blue-500">
            Show More <FaChevronDown className="text-xl" />
          </p>
